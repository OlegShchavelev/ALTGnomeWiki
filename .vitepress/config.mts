...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `2023-${new Date().getFullYear()} ALT Gnome Wiki, разработано на платформе <a href="//vitepress.dev/">VitePress v1.2.3</a>`
    },
    asideMeta: {
      keywords: {
        core: {
      ...
      links: {
        ...
        about_app: {
          anchor: 'Подробнее',
          target: '_blank',
          style: '--agw-btn-bg: var(--vp-c-green-dimm-1); --agw-btn-color: var(--vp-c-green-darker); --agw-btn-hover-bg:var(--vp-c-green-dark); --agw-btn-hover-color: var(--vp-c-white);'
        }
      }
    }
  },
