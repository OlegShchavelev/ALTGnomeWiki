export const gitRepository = "https://github.com/OlegShchavelev/ALTRegularGnomeWiki"
export const gitMaxCommits = 20000

export const gitDisplay = {
    disableChangelog: false,
    disableContributors: false
}


export const gitRewritePath = {
    "docs/apps/": "",
    "docs/developers/": "",
    "docs/equipment/": "",
    "docs/extensions/": "",
...
export const gitMapContributors = [
    {
      name: "Владимир Васьков",
      avatar: "https://github.com/Rirusha.png",
      nameAliases: ["Rirusha", "Vladimir Vaskov"]
    },
    {
        name: "Олег Щавелев",
        avatar: "https://github.com/OlegShchavelev.png",
        nameAliases: ["OlegShchavelev", "Oleg Shchavelev", "Олег Щавелев"]
    },
    {
        name: "Семен Фомченков",
        avatar: "https://github.com/Armatik.png",
        nameAliases: ["Semen Fomchenkov", "Armatik", "armatik"]
    },
    {
        name: "Кирилл Уницаев",
        avatar: "https://github.com/fiersik.png",
        nameAliases: ["fiersik", "Fiersik Kouji"]
    },
    {
        name: "iQQator",
        avatar: "https://github.com/iDevPro.png",
        nameAliases: ["Субач Павел", "iQQator", "iDevPro"]
    },
    {
    ...
    },
    {
        ...
        nameAliases: ["vldmr_true", "otetswoo"]
    },
    {
        name: "Дмитрий Орлов",
    ...
    },
    {
        ...
        nameAliases: ["Feytell228", "feyte11" ,"Khachatur Tonikyan"]
    },
    {
        name: "Антон Политов",
        avatar: "https://github.com/Ampernic.png",
        nameAliases: ["Ampernic", "Антон Политов"]
    },
    {
        name: "Илья Женецкий",
        avatar: "https://github.com/ilyazheprog.png",
        nameAliases: ["ilyazheprog", "Ilya Zhenetskij"]
    },
    {
        name: "Алексей Камаев",
        avatar: "https://github.com/a1ex-ak.png",
        nameAliases: ["Alexey Kamaev", "a1ex-ak"]
    },
    {
        name: "AnameVi",
