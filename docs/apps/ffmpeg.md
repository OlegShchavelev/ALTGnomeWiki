...
Для получения краткой информации, воспользуйтесь ключём `hide_banner`:
...
::: warning
Необходимо ипереименовать файлы по одному паттерну: `гифка_0001.png`, `гифка_0002.png` и так далее
:::
