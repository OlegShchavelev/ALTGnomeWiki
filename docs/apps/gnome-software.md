...
Центр приложений (Gnome Software) — официальная утилита для рабочего стола GNOME, позволяющая находить и устанавливать новые приложения и системные расширения, а также удалять уже установленные.
