...
Эта команда ещё раз пересоберёт пакет на сборочнице, и если всё пройдет удачно пакет попадёт в Сизиф при следущём обновлении репозитория (примерно три часа ночи по МСК)
