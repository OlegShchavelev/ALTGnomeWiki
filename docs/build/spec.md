...
**Source** -  Источник. Перед сборкой пакета, согласно правил **rules** создаются архивы формата tar со сжатым исходным кодом. Актуально при локальной сборке по средствам хешер из склонированного репозитория того же ГитХаб (как вариант).
...
:::info
Для получения корректного перечня конечных файлов, рекомендую заремить блок команд в разделе install, дабы не собрать кривой пакет, который может успешно собраться, а может не собраться из-за путей 
:::
