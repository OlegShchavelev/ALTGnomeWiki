...
При установке epm автоматически определит, что устанавленный файл не является стандартным и запустит комманду epm repack, а после переупаковки пакета, автоматически установит переупакованный пакет. 
