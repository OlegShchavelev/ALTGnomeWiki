# Аппаратная совместимость обородования
...
| Производитель | Модель | Состояние | ПО | Примечание |
| :---: | :---: | :---: | :---: | :---: |
| Дарк Проджект | KD98 | :green_circle: | - | [Работа клавиш Fn в функциональном режиме](dark-project-keyboard-on-linux.md), Раскалдка Win |
| Дарк Проджект | KD85 | :green_circle: | - | Раскалдка Win |
| Apple |
| Logitech | MX Keys | :green_circle: | [`Solaar`](https://pwr-solaar.github.io/Solaar/) | - |
| Кeychron | K3D1 | :green_circle: | - | Раскалдка Win, BT+Cable |
...
2. Все таблицы должны быть оформлены в формате Markdown.
...
Дополнительная информация об устройстве, его рабостопособности, краткие описание возможности восстановления работы устройства или ссылка на страницу в ALT Gnome Wiki/Внешний ресурс с подробной информацией.
