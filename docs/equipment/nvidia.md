...
Проприетарный драйвер разрабатывается самой компанией [NVIDIA](https://www.nvidia.com/) и являются проприетарной разработкой, в следствии чего поставляются отдельно от ядра Linux и требуют отдельной установки (В отличии от открытых драйверов Nouveau, которые уже есть в системе).
...
Данный драйверй изначально присутствует в системе и их установка не требуется.
