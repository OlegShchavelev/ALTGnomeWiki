...
## Полезные пакеты
::: info
При установке драйверов через **EPM**, многие пакеты, скорее всего уже будут установлены.
...
системами конфигурации дистрибутива Linux, такими как udev. По возможности
рекомендуется использовать встроенные механизмы вашего дистрибутива Linux
