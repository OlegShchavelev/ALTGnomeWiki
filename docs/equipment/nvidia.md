...
И всё это не влияя на функциональность, продолжая функционировать, просто на меньшей скорости. Эта функция позволяет более гибко потреблять энергию и экононмить аккумулятор ноутбука.
