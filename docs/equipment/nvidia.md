...
### Для корректной работы сна или гибернизации в режиме wayland, необходимо правильное сохранение выделенных ресурсов видеопамяти.
...
Еще один из вариантов (на десктопной машине), это выполнить настроить сон видеокарты согласно настройкам из [Настройка гибернации](https://alt-gnome.wiki/nvidia.html#_1-способ-через-сохранение-выделенных-ресурсов-в-безымянных-временных-фаилах)
