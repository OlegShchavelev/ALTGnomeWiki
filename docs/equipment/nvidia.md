...
Также, из-за постоянного развития и изменения драйверов NVIDIA, разные версии драйверов имеют свои нюансы и ограничения, именно поэтому [важно знать версию своих драйверов и информацию, связанную с ними](nvidia.md#настройка-драйверов).
...
В остальном, информация актуальна как для [последних драйверов](./nvidia.md#актуальные-драйвера-54529-и-новее)
...
В остальном, информация актуальна как для [драйверов < 545.29](./nvidia.md#для-драйверов--54529)
...
В остальном, информация актуальна как для [драйверов < 470.223.02](./nvidia.md#для-драйверов--47022302)
...
В остальном, информация актуальна как для [драйверов < 390.157](./nvidia.md#для-драйверов--390157)
...
В остальном, информация актуальна как для [драйверов < 340.108](./nvidia.md#для-драйверов--340108)
...
### После настроек для [сессии wayland](./nvidia.md#cессия-wayland), wayland в GDM не появляется
