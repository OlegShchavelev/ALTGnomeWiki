...
В это управление входит регулирование тактовой частоты и напряжение на разных участках микросхемы, а также, в некоторых случаях, полное отключение тактовой частоты или питания частей чипа. 
...
Драйвера NVIDIA позволяют сменить расширение для страничная организация памяти с [MTRR на PAT](https://wiki.gentoo.org/wiki/MTRR_and_PAT).
PAT более современная технология и является более гибким добавляя новые возможности для организации памяти.
