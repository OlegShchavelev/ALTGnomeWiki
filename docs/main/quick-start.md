...
Зайдите в приложение «Настройки», перейдите в панель «Питание», активируйте настройку «Показать процент заряда в батареи». Альтернативном вариантом изменение gsettings, к примеру через терминал:
