...
- Подготовьте загружаемый установочный носитель. Как это сделать описано в статье [«Создание загрузочного диска ALT Regular Gnome»](/installations/bootable-drive/);
