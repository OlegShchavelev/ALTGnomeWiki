...
[ALT Workstation Gnome<Badge type="tip" text="x86_64"  /><Badge type="danger" text="Релиз-кандидат 1" />](https://beta.altlinux.org/workstation/x86_64/alt-workstation-11.0rc1-20250404-x86_64.iso)

[ALT Workstation Gnome<Badge type="tip" text="aarch64" /><Badge type="danger" text="Релиз-кандидат 1" />](https://beta.altlinux.org/workstation/aarch64/alt-workstation-11.0rc1-20250404-aarch64.iso)
