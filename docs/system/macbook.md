...
## Установка
Настоятельно рекомендую, возьми диск, nas или ещё что-либо равное объёму диска макбука и сделай TimeMachine резервную копию.
Линукс это круто и безвозвратный прыжок в этот мир, может помочь бороться с трудностями, но лучше иметь бекап, чем не иметь.
