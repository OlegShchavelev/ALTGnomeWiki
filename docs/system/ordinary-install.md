...
- постарайтесь убедиться в том, что компьютер функционирует корректно (диски, микросхемы памяти, процессор, сетевые и другие периферийные устройства не возвращают сообщения об ошибках);
...
![Выбрать "Install ALT regular-gnome/x86-64" и нажать ENTER](../public/ordinary-install/inst-picture1.png)

:::

### Шаг установки №1. Язык

На первом шаге установке выбирается язык. Это значит, что программа установки установленная система будет использовать заданный язык и локализацию.

::: tip Выбирайте русский язык, желаемую комбинацию клавиш для переключения языка и нажмите "__Далее__"

![Выбрать "Русский", желаемую комбинацию переключения языка, нажать "Далее"](../public/ordinary-install/inst-picture2.png)
...
![Отметить "Да, я согласен с условиями", нажать "Далее"](../public/ordinary-install/inst-picture3.png)
...
![Пример использования значений по умолчанию, нажмите "Далее"](../public/ordinary-install/inst-picture4.png)
...
![Укажите ваш часовой пояс (например, для Иркутска) и нажмите "Далее"](../public/ordinary-install/inst-picture6.png)
...
![Осуществите выбор варианта разметки диска и нажмите "Далее"](../public/ordinary-install/inst-picture7.png)

:::

Затем программа установки предупредит вас о необратимости изменений. Если на вашем диске были данные, ещё раз подумайте о том, нужны ли они, и есть ли у вас актуальная резервная копия. После этого действия все ваши данные будут уничтожены, и их восстановление превратится в довольно трудоёмкий и сложный процесс, без гарантии получить успешный результат и вернуть данные.

::: tip Ещё раз подумайте, и если данные на диске вам больше не нужны, или есть их актуальная резервная копия -- нажмите "__ОК__"

![Не нажимайте "ОК" до тех пор, пока вы не убедитесь в том, что данные вам не нужны, или в том, что имеется актуальная резервная копия](../public/ordinary-install/inst-picture8.png)
...
::: tip Подтвердите конфигурацию разметки диска и нажмите "__Далее__"

![Подтвердите конфигурацию разметки диска и нажмите "Далее"](../public/ordinary-install/inst-picture9.png)

:::

Ещё раз подтвердите свои действия и продолжайте установку.

::: tip Подтвердите действия и нажмите "__OK__"

![Подтвердите действия и нажмите "OK"](../public/ordinary-install/inst-picture10.png)
...
![Пример установки базовой системы](../public/ordinary-install/inst-picture11.png)
...
![Пример установки системы](../public/ordinary-install/inst-picture12.png)
...
![Пример окна сохранения настроек](../public/ordinary-install/inst-picture13.png)
...
![Отметьте чекбокс "Установить или сбросить пароль", заполните поля с парольной фразой загрузчика и нажмите "Далее"](../public/ordinary-install/inst-picture14.png)
...
![Согласитесь с предложением по умолчанию и нажмите "Далее"](../public/ordinary-install/inst-picture15.png)
...
![Укажите имя системы и нажмите "Далее"](../public/ordinary-install/inst-picture16.png)
...
![Задайте пароль администратора системы и нажмите "Далее"](../public/ordinary-install/inst-picture17.png)
...
![Задайте имя и пароль для пользователя и нажмите "Далее"](../public/ordinary-install/inst-picture18.png)
...
![Завершение установки, нажмите "Завершить"](../public/ordinary-install/inst-picture18.png)
