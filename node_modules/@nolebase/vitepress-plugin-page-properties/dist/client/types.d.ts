...
export interface DynamicProperty<K extends PropertyKey> {
    ...
    key: K | string;
    title: string;
    options: DynamicWordsCountProperty | DynamicReadingTimeProperty;
}
...
export type Property<K extends PropertyKey> = TagsProperty<K> | PlainProperty<K> | DatetimeProperty<K> | ProgressProperty<K> | LinkProperty<K> | DynamicProperty<K>;
