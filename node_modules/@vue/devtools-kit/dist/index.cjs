...
var _a2, _b2;
(_b2 = (_a2 = import_devtools_shared3.target).__VUE_DEVTOOLS_KIT_APP_RECORDS__) != null ? _b2 : _a2.__VUE_DEVTOOLS_KIT_APP_RECORDS__ = [];
var _a3, _b3;
(_b3 = (_a3 = import_devtools_shared3.target).__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__) != null ? _b3 : _a3.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__ = {};
var _a4, _b4;
(_b4 = (_a4 = import_devtools_shared3.target).__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD_ID__) != null ? _b4 : _a4.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD_ID__ = "";
var _a5, _b5;
(_b5 = (_a5 = import_devtools_shared3.target).__VUE_DEVTOOLS_KIT_CUSTOM_TABS__) != null ? _b5 : _a5.__VUE_DEVTOOLS_KIT_CUSTOM_TABS__ = [];
var _a6, _b6;
...
var _a7, _b7;
(_b7 = (_a7 = import_devtools_shared3.target)[STATE_KEY]) != null ? _b7 : _a7[STATE_KEY] = initStateFactory();
...
var devtoolsAppRecords = new Proxy(import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_APP_RECORDS__, {
  get(_target, prop, receiver) {
    if (prop === "value")
      return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_APP_RECORDS__;
    return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_APP_RECORDS__[prop];
  }
});
var addDevToolsAppRecord = (app) => {
  import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_APP_RECORDS__ = [
    ...import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_APP_RECORDS__,
    app
  ];
};
var removeDevToolsAppRecord = (app) => {
  import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_APP_RECORDS__ = devtoolsAppRecords.value.filter((record) => record.app !== app);
};
var activeAppRecord = new Proxy(import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__, {
  get(_target, prop, receiver) {
    if (prop === "value")
      return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__;
    else if (prop === "id")
      return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD_ID__;
    return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__[prop];
  }
});
function updateAllStates() {
  callStateUpdatedHook({
    ...import_devtools_shared3.target[STATE_KEY],
    appRecords: devtoolsAppRecords.value,
    activeAppRecordId: activeAppRecord.id,
    tabs: import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_CUSTOM_TABS__,
    commands: import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_CUSTOM_COMMANDS__
  });
}
function setActiveAppRecord(app) {
  import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__ = app;
  updateAllStates();
}
function setActiveAppRecordId(id) {
  import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD_ID__ = id;
  updateAllStates();
}
var devtoolsState = new Proxy(import_devtools_shared3.target[STATE_KEY], {
  get(target21, property) {
    if (property === "appRecords") {
      ...
      return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_CUSTOM_TABS__;
    } else if (property === "commands") {
      return import_devtools_shared3.target.__VUE_DEVTOOLS_KIT_CUSTOM_COMMANDS__;
    }
...
function resetDevToolsState() {
  Object.assign(import_devtools_shared3.target[STATE_KEY], initStateFactory());
}
function updateDevToolsState(state) {
  ...
  if (oldState.connected !== state.connected && state.connected || oldState.clientConnected !== state.clientConnected && state.clientConnected) {
    callConnectedUpdatedHook(import_devtools_shared3.target[STATE_KEY], oldState);
  }
  Object.assign(import_devtools_shared3.target[STATE_KEY], state);
  updateAllStates();
}
...
function createDevToolsCtxHooks() {
  const hooks2 = (0, import_hookable2.createHooks)();
...
var _a10, _b10;
(_b10 = (_a10 = import_devtools_shared7.target)[ROUTER_INFO_KEY]) != null ? _b10 : _a10[ROUTER_INFO_KEY] = {
  currentRoute: null,
  routes: []
};
var _a11, _b11;
...
function normalizeRouterInfo(appRecord, activeAppRecord2) {
  function init() {
    ...
    import_devtools_shared8.target[ROUTER_INFO_KEY] = {
      currentRoute: currentRoute ? (0, import_devtools_shared8.deepClone)(currentRoute) : {},
      routes: (0, import_devtools_shared8.deepClone)(routes)
    };
    import_devtools_shared8.target[ROUTER_KEY] = router;
    console.warn = c;
  }
  init();
...
var _a12, _b12;
(_b12 = (_a12 = import_devtools_shared9.target).__VUE_DEVTOOLS_COMPONENT_INSPECTOR_ENABLED__) != null ? _b12 : _a12.__VUE_DEVTOOLS_COMPONENT_INSPECTOR_ENABLED__ = true;
function toggleComponentInspectorEnabled(enabled) {
  import_devtools_shared9.target.__VUE_DEVTOOLS_COMPONENT_INSPECTOR_ENABLED__ = enabled;
}
function waitForInspectorInit(cb) {
  let total = 0;
  const timer = setInterval(() => {
    if (import_devtools_shared9.target.__VUE_INSPECTOR__) {
      clearInterval(timer);
      total += 30;
      cb();
    }
...
function setupInspector() {
  const inspector = import_devtools_shared9.target.__VUE_INSPECTOR__;
...
function getComponentInspector() {
  return new Promise((resolve) => {
    function setup() {
      setupInspector();
      resolve(import_devtools_shared9.target.__VUE_INSPECTOR__);
    }
    if (!import_devtools_shared9.target.__VUE_INSPECTOR__) {
