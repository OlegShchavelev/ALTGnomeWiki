...
export declare function createWeightCostCalculator(weightMap: WeightMap): _WeightCostCalculator;
declare class _WeightCostCalculator implements WeightCostCalculator {
    readonly weightMap: WeightMap;
