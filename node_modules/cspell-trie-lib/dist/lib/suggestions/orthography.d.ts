export declare const compare: (x: string, y: string) => number;
/**
 ...
 */
export declare const visualLetterGroups: string[];
/**
 ...
 */
export declare const visualLetterMaskMap: Record<string, number | undefined>;
