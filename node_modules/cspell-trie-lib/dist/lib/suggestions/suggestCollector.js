...
export function compSuggestionResults(a, b) {
...
export const defaultSuggestionCollectorOptions = Object.freeze({
...
export function suggestionCollector(wordToMatch, options) {
 ...
 */
export function impersonateCollector(collector, word) {
    const r = Object.create(collector);
    Object.defineProperty(r, 'word', { value: word, writable: false });
    return r;
}
export function isSuggestionResult(s) {
    const r = s;
